...
const integrations = [
  ...
  {
    name: "WhatsApp (Railway BYOS)",
    description: "Users deploy their own WhatsApp bot backend on Railway and connect it to HeHo",
    features: [
      "Bring-your-own-server model (user-hosted Railway backend)",
      "Deploy with Railway template + auto-filled env vars",
      "Live QR displayed in HeHo UI for quick pairing",
      "Connected status reflected back into chatbot settings",
      "Messages relay through HeHo API for AI responses",
    ],
    status: "Active",
  },
  {
