        ...
        <div className="fixed inset-0 z-[60] bg-black/70 flex items-center justify-center p-4">
          <div className="bg-background border rounded-lg shadow-xl w-full max-w-3xl p-4 space-y-4">
            ...
            <div className="grid gap-4 lg:grid-cols-[2fr_1fr]">
              <div className={cn("w-full border rounded-md bg-black/70 overflow-hidden relative", cropAspectClass)}>
                <img
                  src={fileUrl}
                  alt="Crop preview"
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <p className="text-xs font-semibold text-muted-foreground">Horizontal position</p>
                  <input
                    type="range"
                    min={-100}
                    max={100}
                ...
                <div className="space-y-2">
                  <p className="text-xs font-semibold text-muted-foreground">Vertical position</p>
                  <input
                    type="range"
                    min={-100}
                    max={100}
